...
import {View, ScrollView, TextInput, Text, Image, Dimensions, StyleSheet, FlatList, Linking} from 'react-native'
...
<ScrollView horizontal = {true} style = {{marginTop: hp(percHeight(10)), marginBottom: hp(percHeight(10)), height: '4%', backgroundColor: 'white',}}>
  ...
  <TouchableOpacity onPress = {() => this.onMoreInfo() }>
      ...
      <View style={{ height: hp(percHeight(500)) }}  >
